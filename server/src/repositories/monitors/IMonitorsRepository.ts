import { type MonitorType, type Monitor, type MonitorNotification, type MonitorsSummary } from "@/types/index.js";
...
export interface IMonitorsRepository {
	...
	updateNotifications(teamId: string, monitorIds: string[], notifications: MonitorNotification[], action: "add" | "remove" | "set"): Promise<number>;
